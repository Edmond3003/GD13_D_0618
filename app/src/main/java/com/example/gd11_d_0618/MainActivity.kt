package com.example.gd11_d_0618
...
import com.example.gd11_d_0618.adapters.MahasiswaAdapter
import com.example.gd11_d_0618.api.MahasiswaApi
import com.example.gd11_d_0618.models.Mahasiswa
        ...
        val stringRequest: StringRequest = object :
            StringRequest(Method.GET, MahasiswaApi.GET_ALL_URL, Response.Listener { response ->
                ...
                try {
                    ...
                    Toast.makeText(this@MainActivity, errors.getString("message"), Toast.LENGTH_SHORT
                    ).show()
                }catch (e: Exception){
